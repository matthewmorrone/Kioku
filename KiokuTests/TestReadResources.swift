...
final class TestReadResources {
    ...
    private init() throws {
        ...
        // The same constructor ContentView uses, so tests score with exactly the frequency map the
        // app does — a hand-built map here is how the two once drifted apart unnoticed.
