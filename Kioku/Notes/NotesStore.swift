...
final class NotesStore: ObservableObject {
    ...
    func flushPendingSave() {
        ...
        if notes.isEmpty, diskSnapshotByID.isEmpty == false {
            ...
            print("[NotesStore] flushPendingSave refused: in-memory empty but disk has \(diskSnapshotByID.count) notes")
            return
        }
    ...
    private func save() {
        if notes.isEmpty, diskSnapshotByID.isEmpty == false {
            ...
            print("[NotesStore] save refused: in-memory empty but disk has \(diskSnapshotByID.count) notes")
            return
        }
    ...
    private static func writeFiles(
        ...
        for note in notes {
            ...
            do {
                ...
                print("[NotesStore] write failed for note \(note.id): \(error)")
            }
        }
        ...
        for id in previousSnapshot.keys where currentIDs.contains(id) == false {
            ...
            do {
                ...
                print("[NotesStore] delete failed for note \(id): \(error)")
            }
        }
        ...
        do {
            ...
            print("[NotesStore] index write failed: \(error)")
        }
    }
