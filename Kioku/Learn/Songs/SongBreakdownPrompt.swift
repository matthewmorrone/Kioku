...
enum SongBreakdownPrompt {
    ...
    static let template: String = """
        ...
        *[romaji matching what is actually sung, not what is written]*
        ...
        - **[word in kanji/kana]** ([romaji]) [grammar tag in square brackets, only for an inflected verb or adjective — e.g. [past], [te-form], [potential], [causative-passive], [negative], [conditional]; omit entirely for dictionary-form words, nouns, and particles] — [plain dictionary gloss, no quotation marks; add one short note after it only when rule 5's (a)-(c) applies]
        ...
        **Gist:** [natural English rendering of the whole line — interpreted IN CONTEXT of the entire song]
        ...
        5. **Depth**: Assume basic grammar and kana fluency. Do not pad with N5-level basics. Do not add anything past the definition unless the word's subtext is genuinely not obvious from its plain meaning. The default word bullet is a dictionary gloss, nothing after it — decayed or withered, petal, twilight, wings. Write the gloss bare: no quotation marks around it or around its alternatives. Stop there unless one of these specifically applies: (a) a near-synonym distinction that would actually confuse the word for a different one (触れる vs 触る, 寒い vs 冷たい, 命 vs 人生 vs 生活, 羽 vs 翅, 雷 vs 稲妻), (b) etymology or register that changes how the word should be read (loanword origin, literary vs colloquial vs classical), or (c) a fixed cultural/seasonal term that carries real established meaning beyond its literal words (mono no aware, 夕凪, 黄昏 = 誰そ彼). If none of (a)-(c) applies, a plain gloss is the entire bullet — do not append a sentence unpacking what the word "suggests," "evokes," "implies," or "can imply." That sentence is manufactured interpretation even when the word is abstract-sounding (朽ちた decayed, 翅 wings, 花びら petal all take a plain gloss and nothing else — none of them meet (a)-(c)). Do NOT include emotional overtones — "carries a sense of loss," "evokes longing," "feels wistful" and the like are exactly the manufactured-interpretation pattern this rule forbids, regardless of how the word sounds. When in doubt, cut the extra sentence.
