...
struct WordsView: View {
    ...
    // matchingGloss / runDictionarySearch moved to WordsView+Search.swift alongside the other
    // search-ranking helpers (isPrimarySenseMatch / isExactSurfaceMatch) — this file sits at
    // the 1000-line invariant cap.
